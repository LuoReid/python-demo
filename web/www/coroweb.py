...
class RequestHandler(object):
    def __init__(self, app, fn):
        ...
        self._has_var_kw_areg = has_var_kw_arg(fn)
    ...
    def __call__(self, request):
        kw = None  # ...获取参数
        if self._has_var_kw_areg or self._has_named_kw_args or self._required_kw_args:
        ...
        if kw is None:
            ...
            if not self._has_var_kw_areg and self._named_kw_args:
                copy = dict()
